import SummarizeData from "./Summarise.mjs";
const sumarize =  new SummarizeData();
const data = [
    ...
    ["Home Theater System", "Technology", "2023-12-19", null, 8, 20],
    ["Executive Office Desk", "Office Supplies", "2023-12-20", 1400, 6, 15],
  ];
const  column  = ["Sales","Quantity"];
console.log(sumarize.summarize(data,column));