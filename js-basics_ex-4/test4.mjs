import { SalesDataCalculator } from './dataSet4.mjs';
...
let data = [
  ...
  const salesDataCaluculate = new SalesDataCalculator(data);
  const resultSum = salesDataCaluculate.parseData("Sales","Quantity", "Discount");
