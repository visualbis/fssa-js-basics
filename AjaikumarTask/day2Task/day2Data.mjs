...
let categorizeData = [
  ...
  dataGroup.categoryFinder(salesData.length, categorizeData);
  

  const RunningTotal = new DataGroup(salesDataWithMonth);
  RunningTotal.runningTotalFinder();
  RunningTotal.showRunningTotal();